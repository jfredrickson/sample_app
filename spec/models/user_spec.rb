...
describe User do
  ...
  describe "password validations" do
    ...
    it "should require a matching password confirmation" do
      mismatched_password = User.new(@attr.merge(:password_confirmation => "invalid"))
      mismatched_password.should_not be_valid
    end
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      it "should return nil on email/password mismatch" do
        wrong_password = User.authenticate(@attr[:email], "wrong")
        wrong_password.should be_nil
      end
      
      it "should return nil for an email address with no user" do
        nonexistent_user = User.authenticate("nonexistent.user@example.org", @attr[:password])
  ...
  describe "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should include the microposts of followed users" do
        ...
        mp3 = Factory(:micropost, :user => followed_user)
  ...
  describe "relationships" do
    ...
    it "should include the follower in the followed user's followers array" do
      @user.follow!(@followed)
